    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$pembelian->id}}</td>
                    <td>{{$pembelian->getCustomerName()}}</td>
                    ...
                    <td>
                        <a href="{{ route('pembelians.cetak', $pembelians) }}" class="btn btn-primary"><i
                            class="fas fa-print"></i></a>
                        <a href="{{ route('pembelians.edit', $pembelians) }}" class="btn btn-primary"><i
                                class="fas fa-edit"></i></a>
                        <button class="btn btn-danger btn-delete" data-url="{{route('pembelians.destroy', $pembelians)}}"><i
